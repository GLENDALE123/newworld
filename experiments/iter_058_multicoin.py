...
def main():
    t0 = time.time()
    print("=" * 60, flush=True)
    print("  ITERATION 058: Multi-Coin Pre-training", flush=True)
    print("=" * 60, flush=True)
    ...
    report = {"iteration": 58, "approach": "Multi-coin pre-training + BTC fine-tune", "time": round(elapsed)}
    with open("reports/iteration_058.json", "w") as f:
